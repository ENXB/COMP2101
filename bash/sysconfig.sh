...
Options:
  ...
  --domain        show only domain info
  --ipconfig      show only ip info
  --os            show only os info
  --cpu           show only cpu info
  --memory        show only memory info
  --disk          show only disk info
  --printer       show only printer info
"
}
